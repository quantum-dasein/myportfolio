...
export const ui = {
  en: {
    ...
    "services.how.title": "Three disciplines, one delivery.",
    "services.how.lead": "Split across three suppliers, these contradict each other: the positioning does not survive production, the search structure gets designed over, and nobody owns the result. Run together they compound, and there is one person to ask when something breaks.",
    ...
    "services.faq.1.q": "Can I book just one of the three?",
    "services.faq.1.a": "Yes, and often that is the right call — a technical SEO pass on an existing site, or a WebGL layer for a brand that already has its positioning settled. The three are listed together because they compound, not because they are sold as a bundle.",
    ...
    "services.faq.3.a": "With a measurement rather than a proposal. A crawl plus Search Console exports usually names the real problem within an hour — and it is frequently not the one that was expected. What comes back is a prioritised list with the numbers next to each item.",
    "services.faq.4.q": "Do you work remotely?",
    "services.faq.4.a": "Based in Vienna, working across Austria and internationally. Both live projects here were delivered remotely for a client in Central Asia, in three languages, so distance is a solved problem rather than a caveat.",
    ...
    // ── Contact form ────────────────────────────────────────────────────────
    "form.title": "Tell me what you need.",
    "form.text":
    ...
    "form.when.quarter": "Within three months",
    "form.when.open": "No fixed date yet",
    "form.budget.label": "Budget range",
    "form.budget.small": "Under €1,000",
    "form.budget.mid": "€1,000 – €3,000",
    "form.budget.large": "€3,000 – €7,000",
    "form.budget.xl": "Over €7,000",
    "form.budget.unsure": "Not sure yet — tell me what it costs",
    "form.email.label": "Your email",
    "form.email.placeholder": "name@company.at",
    "form.message.label": "Anything else (optional)",
    "form.message.placeholder": "A link to your current site, or one line about the business.",
    "form.submit": "Send it",
  ...
  de: {
    ...
    "services.how.title": "Drei Disziplinen, eine Auslieferung.",
    "services.how.lead": "Auf drei Dienstleister verteilt widersprechen sie einander: Die Positionierung übersteht die Produktion nicht, die Search-Struktur wird überdesignt, und niemand verantwortet das Ergebnis. Zusammen geführt verstärken sie sich — und es gibt eine Person, die man fragt, wenn etwas kaputtgeht.",
    ...
    "services.faq.1.q": "Kann ich nur eine der drei buchen?",
    "services.faq.1.a": "Ja, und oft ist das richtig — ein Technical-SEO-Durchgang auf einer bestehenden Website oder eine WebGL-Ebene für eine Marke, deren Positionierung längst steht. Die drei stehen zusammen, weil sie sich verstärken, nicht weil sie als Paket verkauft werden.",
    ...
    "services.faq.3.a": "Mit einer Messung statt mit einem Angebot. Ein Crawl plus Search-Console-Exporte benennt das eigentliche Problem meist innerhalb einer Stunde — und es ist oft nicht das erwartete. Zurück kommt eine priorisierte Liste mit den Zahlen neben jedem Punkt.",
    "services.faq.4.q": "Arbeiten Sie remote?",
    "services.faq.4.a": "Sitz in Wien, tätig in ganz Österreich und international. Beide Live-Projekte hier entstanden remote für einen Kunden in Zentralasien, in drei Sprachen — Distanz ist also ein gelöstes Problem und kein Vorbehalt.",
    ...
    // ── Kontaktformular ─────────────────────────────────────────────────────
    "form.title": "Sagen Sie mir, was Sie brauchen.",
    "form.text":
    ...
    "form.when.quarter": "Innerhalb von drei Monaten",
    "form.when.open": "Noch kein fixer Termin",
    "form.budget.label": "Budgetrahmen",
    "form.budget.small": "Unter 1.000 €",
    "form.budget.mid": "1.000 – 3.000 €",
    "form.budget.large": "3.000 – 7.000 €",
    "form.budget.xl": "Über 7.000 €",
    "form.budget.unsure": "Weiß ich noch nicht — sagen Sie mir, was es kostet",
    "form.email.label": "Ihre E-Mail",
    "form.email.placeholder": "name@firma.at",
    "form.message.label": "Sonst noch etwas? (optional)",
    "form.message.placeholder": "Ein Link zu Ihrer aktuellen Website oder ein Satz zum Unternehmen.",
