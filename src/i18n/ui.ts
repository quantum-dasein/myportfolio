...
export const ui = {
  en: {
    ...
    "studio.sys.title": "Six systems, none of them decoration.",
    ...
    "services.faq.3.a": "With scope in writing, not with a proposal. You pick the size of the job above, say what it has to do and by when, and one fixed number and a launch date come back — usually the same day. If the work is on a site that already exists, the first step is a crawl and Search Console data instead, because there the real problem is usually not the one that was expected.",
    "services.faq.4.q": "Do you work remotely?",
    "services.faq.4.a": "Based in Vienna, working across Austria and internationally. The live projects here were delivered remotely for a client in Central Asia, in three languages, so distance is a solved problem rather than a caveat.",
    ...
    "research.2.text": "429 pages and 117 expert articles, structured to be found.",
  ...
  de: {
    ...
    "studio.sys.title": "Sechs Systeme, keines davon Dekoration.",
    ...
    "services.faq.3.a": "Mit schriftlichem Scope statt mit einem Angebot. Sie wählen oben die Größe des Projekts, sagen, was es leisten soll und bis wann — und bekommen eine feste Zahl und einen Launch-Termin zurück, meist noch am selben Tag. Geht es um eine bestehende Website, steht am Anfang stattdessen ein Crawl mit Search-Console-Daten: Dort ist das eigentliche Problem meist nicht das erwartete.",
    "services.faq.4.q": "Arbeiten Sie remote?",
    "services.faq.4.a": "Sitz in Wien, tätig in ganz Österreich und international. Die Live-Projekte hier entstanden remote für einen Kunden in Zentralasien, in drei Sprachen — Distanz ist also ein gelöstes Problem und kein Vorbehalt.",
    ...
    "research.2.text": "429 Seiten und 117 Fachartikel, strukturiert zum Gefundenwerden.",
    ...
    "404.subtitle": "Sie sind vom Kurs abgekommen. Diese Koordinaten existieren nicht im aktuellen Raum.",
